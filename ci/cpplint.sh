...
#
#  Copyright (C) 2015, 2016, 2021, 2022  Dirk Stolle
#
...
find ./ \( -name '*.cpp' -o -name '*.hpp' -o -name '*.h' \) -print0 | xargs -0 -i $CXX $CFLAGS -fsyntax-only -Wall -Wextra -Wpedantic -pedantic-errors -Wshadow --std=c++17 {}
if [[ $? -ne 0 ]]
then
