...
if [[ ! -f "$THIS_DIR/unshield-the-feeble-files-spanish.zip" ]]
then
  # get the zipped InstallShield cabinet
  wget https://www.dropbox.com/s/1ng0z9kfxc7eb1e/unshield-the-feeble-files-spanish.zip?dl=1 \
   --output-document="$THIS_DIR/unshield-the-feeble-files-spanish.zip"
  if [[ $? -ne 0 ]]
  then
