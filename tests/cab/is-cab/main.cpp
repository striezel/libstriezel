...
int main(int argc, char** argv)
{
  ...
  {
    //construct file name
    const std::string fileName = cabDirectory + libthoro::filesystem::pathDelimiter + item.first;
    //existence check
    ...
    const bool isCAB = libthoro::cab::archive::isCab(fileName);
  ...
  //All OK.
  std::cout << "Tests for libthoro::cab::archive::isCab() were successful." << std::endl;
  return 0;
}
