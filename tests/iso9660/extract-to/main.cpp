...
int main(int argc, char** argv)
{
  ...
  try
  {
    ...
    const std::string destFile = libstriezel::filesystem::slashify(tempDirName) + e6.basename();
  ...
  //Everything is OK.
  std::cout << "Test for libstriezel::iso9660::archive::extractTo() was successful." << std::endl;
  return 0;
}
