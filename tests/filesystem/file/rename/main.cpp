...
int main(int argc, char** argv)
{
  ...
  if (!libthoro::filesystem::file::createTemp(originalFileName))
  {
  ...
  if (libthoro::filesystem::file::exists(newFileName))
  {
  ...
  //move file
  if (!libthoro::filesystem::file::rename(originalFileName, newFileName))
  {
  ...
  if (libthoro::filesystem::file::exists(originalFileName))
  {
  ...
  if (!libthoro::filesystem::file::remove(newFileName))
  {
