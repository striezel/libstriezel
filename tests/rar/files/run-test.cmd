...
if NOT EXIST "%THIS_DIR%\BEER_v112-04_Update.rar" (
  :: get the rar archive for a Morrowind plugin
  wget 'https://web.archive.org/web/20161109185313if_/http://mw.modhistory.com/file.php?id=14817' --output-document="%THIS_DIR%\BEER_v112-04_Update.rar"
  if %ERRORLEVEL% NEQ 0 (
