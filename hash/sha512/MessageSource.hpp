...
#ifndef LIBTHORO_SHA512_MESSAGESOURCE_HPP
#define LIBTHORO_SHA512_MESSAGESOURCE_HPP
...
class MessageSource
{
  ...
  protected:
    ...
    enum PaddingStatus {psUnpadded, psPadded1024, psPadded2048, psPadded2048And1024Read, psPaddedAndAllRead};
    PaddingStatus m_Status;
}; //class

} //namespace SHA512

#endif // LIBTHORO_SHA512_MESSAGESOURCE_HPP
