/*
 -----------------------------------------------------------------------------
    ...
    Copyright (C) 2012, 2915  Thoronador
...
#ifndef LIBTHORO_SHA256_FILESOURCEUTILITY_HPP
#define LIBTHORO_SHA256_FILESOURCEUTILITY_HPP
...
#endif // LIBTHORO_SHA256_FILESOURCEUTILITY_HPP
